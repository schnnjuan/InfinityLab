...
class _MainAppState extends State<MainApp> {
              ...
              children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            ...
                            border: const Border(right: const BorderSide(color: AppColors.borderColor, width: 1.0)),
                            borderRadius: const BorderRadius.all(Radius.circular(8.0)), // Added rounded corners
                          ),
                          child: Column(
                        ...
                        Expanded(
                          child: Center(
                            child: DragTarget<ElementModel>(
                              ...
                              onWillAccept: (data) => true, // Accept any ElementModel
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration( // Added const
                            color: AppColors.panelBackground,
                            border: const Border(left: const BorderSide(color: AppColors.borderColor, width: 1.0)), // Added const
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    border: const Border(top: const BorderSide(color: AppColors.borderColor, width: 1.0)),
                    borderRadius: const BorderRadius.all(Radius.circular(8.0)), // Added rounded corners
                  ),
                  child: Column(
                    children: [
  ...
  Widget _buildInventoryItem(ElementModel element) {
    return Draggable<ElementModel>(
      ...
      childWhenDragging: Container(width: 56, height: 56), // Empty space when dragging
      child: Padding(
